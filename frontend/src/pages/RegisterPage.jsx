    ...
    <div className="flex items-center justify-center h-screen animated-bg">
      <div className="bg-zinc-800 max-w-md w-full p-10 rounded-md">
        ...
        <form onSubmit={onSubmit}>
          ...
          />
          {errors.rrss_1 && (
            <p className="text-red-500">Social network link is required</p>
          )}

          <button
            type="submit"
            className="w-full bg-blue-500 text-white px-4 py-2 rounded-md my-2 hover:bg-blue-600 transition-colors"
          >
            Register
          </button>
        </form>
        <p className="flex gap-x-2 justify-between text-white mt-4">
